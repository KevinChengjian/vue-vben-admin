...
export async function listApi(params: any = {}) {
  return requestClient.post<ListItem[]>('/admin/fruiting-pick/list', params);
}
...
export async function createApi(params: any) {
  return requestClient.post<any>('/admin/fruiting-pick/create', params);
}
...
export async function updateApi(params: any) {
  return requestClient.post<any>('/admin/fruiting-pick/update', params);
}
...
export async function deleteApi(params: any) {
  return requestClient.post<any>('/admin/fruiting-pick/delete', params);
}
